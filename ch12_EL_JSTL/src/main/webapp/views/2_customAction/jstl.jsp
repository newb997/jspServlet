...
<body>
	...
	<p>
		...
		공통적으로 자주 사용하는 코드들의 집합으로 보다 쉽게 사용할 수 있도록 태그화해서 표준으로 제공하는 라이브러리 <br>
		필요한 라이브러리를 추가후 사용가능
	</p>
	
	<h3>* JSTL 선언 방법</h3>
	<p>
		JSTL을 사용하려면 해당 JSP페이지 상단에 taglib지시어를 사용하여 선언해야함 <br><br>
	...
	<p>숫자, 날짜, 시간 데이터의 출력 형식을 지정할 때 사용하는 문법을 제공</p>
